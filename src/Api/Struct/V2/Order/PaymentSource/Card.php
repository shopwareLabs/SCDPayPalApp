...
use Swag\PayPalApp\Api\Struct\V2\Order\PaymentSource\Card\AuthenticationResult;
use Swag\PayPalApp\Api\Struct\V2\Order\PaymentSource\Card\StoredCredential;
