...
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\Evidence\Document;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\Evidence\DocumentCollection;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\Evidence\EvidenceInfo;
