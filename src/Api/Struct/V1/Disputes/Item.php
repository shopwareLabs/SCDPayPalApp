...
namespace Swag\PayPalApp\Api\Struct\V1\Disputes;

use OpenApi\Attributes as OA;
use Swag\PayPalApp\Api\Struct\PayPalApiStruct;
use Swag\PayPalApp\Api\Struct\V1\Common\Link;
use Swag\PayPalApp\Api\Struct\V1\Common\LinkCollection;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\Adjudication;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\AdjudicationCollection;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\CommunicationDetails;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\DisputeAmount;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\DisputedTransaction;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\DisputedTransactionCollection;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\DisputeOutcome;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\Evidence;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\EvidenceCollection;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\Extensions;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\Message;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\MessageCollection;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\MoneyMovement;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\MoneyMovementCollection;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\Offer;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\PartnerAction;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\PartnerActionCollection;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\RefundDetails;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\SupportingInfo;
use Swag\PayPalApp\Api\Struct\V1\Disputes\Item\SupportingInfoCollection;
